...
const CustomerSupportDashboard: React.FC = () => {
        ...
        messages: [
          {
            ...
            sender: 'user',
            senderName: 'John Doe',
            message: 'I am unable to withdraw my BTC. The transaction keeps failing.',
        ...
        messages: [
          {
            ...
            message: 'My KYC has been pending for 3 days. Can you please check?',
          ...
          },
          {
            ...
            message: 'We are reviewing your documents. You will receive an update within 24 hours.',
      ...
      },
      {
        ...
        messages: [
          ...
          },
          {
            ...
            message: 'Please regenerate your API key and ensure you have the correct permissions.',
  ...
  const stats = {
    ...
    avgResponseTime: agents.reduce((sum, agent) => sum + agent.avgResponseTime, 0) / agents.length
  };
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Manage customer inquiries and support tickets</p>
        </div>
                    ...
                    {agents.map((agent) => (
                      <div key={agent.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="text-right">
                          <div className="text-sm font-semibold">{agent.activeTickets} active</div>
                          <div className="text-xs text-gray-500">{agent.resolvedToday} resolved today</div>
                        </div>
                      </div>
                    ))}
                  </div>
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-4">
                            ...
                            <div>
                              <div className="font-semibold">{ticket.subject}</div>
                              <div className="text-sm text-gray-600">{ticket.userName} • {ticket.email}</div>
                      ...
                      <CardContent className="p-6">
                        <div className="flex items-center space-x-4 mb-4">
                          <div className="relative">
                            ...
                            <div className={`absolute -bottom-1 -right-1 w-6 h-6 rounded-full border-4 border-white ${getAgentStatusColor(agent.status)}`}></div>
                          </div>
                          <div>
                            <div className="font-semibold text-lg">{agent.name}</div>
                            <div className="text-gray-600">{agent.email}</div>
                            <div className="text-sm text-gray-500 capitalize">{agent.status}</div>
                          </div>
                        </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-semibold text-green-600">{agent.resolvedToday}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Avg Response:</span>
                            <span className="font-semibold">{agent.avgResponseTime}m</span>
                          </div>
                        </div>
          ...
          <TabsContent value="analytics" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {['trading', 'account', 'kyc', 'technical', 'billing', 'other'].map((category) => {
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold">{stats.avgResponseTime.toFixed(1)} minutes</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-green-600">87.8%</span>
                    </div>
                    <div className="flex justify-between">
            ...
            <div className="bg-white rounded-lg p-6 max-w-4xl max-h-[90vh] overflow-y-auto w-full mx-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div><strong>Category:</strong> 
                      <Badge className={`ml-2 ${getCategoryColor(selectedTicket.category)}`}>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <div><strong>Name:</strong> {selectedTicket.userName}</div>
                    <div><strong>Email:</strong> {selectedTicket.email}</div>
                    <div><strong>User ID:</strong> {selectedTicket.userId}</div>
                  </div>
                </div>
