...
}func createWallet(u:Int,b:String="ethereum")->[String:Any]{let a="0x"+String((0..<40).map{_ in String(format:"%02x",Int.random(in:0...255))}.joined());return["address":a,"seed":"abandon ability able about above absent absorb abstract absurd abuse access accident account accuse achieve acid acoustic acquire across act action actor actress actual adapt add adjust admin admit adult advance advice aerobic affair afford afraid again age agency agent agree ahead aim air airport alarm album alcohol alien alike alive allow alone along alpha already also alter always amazing among amount analyze ancient angle angry animal anniversary announce another answer antenna anxiety any apart apology appear apple approve april aqua arabian architecture area argue arise armed armor army around arrange arrest arrival arrive arrow artist artwork".split(separator:" ").prefix(24).joined()),"blockchain":b,"ownership":"USER_OWNS","userId":u]}
