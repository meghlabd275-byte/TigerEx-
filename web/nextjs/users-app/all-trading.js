/**
 * TigerEx All Trading Features - Next.js
 */
const features = [
  { name: 'Spot Trading', desc: 'Buy/Sell instantly', icon: '💰' },
  { name: 'Futures USDT/COIN', desc: 'Up to 125x leverage', icon: '📈' },
  { name: 'Options', desc: 'Greek indicators', icon: '🎯' },
  { name: 'Margin', desc: '10x borrow', icon: '📊' },
  { name: 'Copy Trading', desc: 'Follow experts', icon: '📋' },
  { name: 'P2P', desc: 'Peer-to-peer', icon: '🤝' },
  { name: 'Pre-Market', desc: 'Before listing', icon: '🚀' },
  { name: 'Prediction', desc: 'Binary bets', icon: '🔮' },
  { name: 'Earn/Staking', desc: 'Up to 20% APY', icon: '💎' },
  { name: 'Wallet', desc: 'Multi-chain', icon: '💰' }
];
export default function AllTrading() {
  return (
    <div style={{padding:'24px',background:'#0B0E14',minHeight:'100vh',color:'#EAECE4',fontFamily:'Inter,sans-serif'}}>
      <header style={{display:'flex',justifyContent:'space-between',padding:'16px 24px',background:'#1C2128',borderRadius:'12px',marginBottom:'24px'}}>
        <div style={{color:'#F0B90B',fontWeight:'700',fontSize:'24px'}}>🐯 TigerEx All Features (Next.js)</div>
        <nav style={{display:'flex',gap:'16px'}}>
          <a href="/spot">Spot</a><a href="/futures">Futures</a><a href="/options">Options</a><a href="/margin">Margin</a>
        </nav>
      </header>
