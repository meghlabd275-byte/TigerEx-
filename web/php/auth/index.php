<?php
/**
 * TigerEx Auth - PHP/jQuery/AJAX Version
 * Security: CSRF protection, XSS filtering, password hashing
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .subtitle { color: var(--text-sec); margin-bottom: 24px; text-align: center; font-size: 14px; }
...
<body>
    <div class="auth-card" id="authCard">
        ...
        <div id="loginView">
            ...
            <div class="input-group">
                ...
                <div class="password-wrapper">
                    ...
                    <button type="button" class="toggle-btn" onclick="togglePassword('loginPassword')">👁️</button>
                </div>
            </div>
        ...
        <div id="signupView" class="hidden">
            ...
            <div id="signupStep2" class="hidden">
                ...
                <p class="subtitle"><a href="#" style="color:var(--primary)">Resend Code</a></p>
            </div>
            ...
            <div id="signupStep4" class="hidden">
                <div class="input-group">
                    ...
                    <div class="password-wrapper">
                        ...
                        <button type="button" class="toggle-btn" onclick="togglePassword('signupPassword')">👁️</button>
                    </div>
    ...
    <script>
        ...
        function showView(viewId) {
            document.querySelectorAll('#authCard > div').forEach(div => div.classList.add('hidden'));
        ...
        function checkStrength() {
            ...
            fill.style.width = pwd.length >= 8 ? '100%' : '0%';
        }
