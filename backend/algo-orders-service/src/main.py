...
"""
TigerEx algo-orders-service
Algorithmic Orders Service - TWAP, VWAP, Iceberg
"""
...
app.include_router(admin_router)
    title="TigerEx algo-orders-service",
...
async def health_check():
    ...
    return {"status": "healthy", "service": "algo-orders-service"}
